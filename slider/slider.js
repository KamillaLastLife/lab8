window.onload=function(){
	...
	// function generate_sliders_id(slider, i) {
	// 	id_value = 'slider_' + i;
	// 	slider.id = id_value;
	// 	console.log(slider.childElementCount);
	// 	buttons = slider.getElementsByClassName("slider__nav-button");
	// 	console.log(buttons);
	// 	console.log(buttons.length);
	// 	for (let j = 0; j < buttons.length; j++){
	// 		// buttons[j].id = id_value;
	// 	}
	// 	console.log('----------------------');
	// }
	...
	// document.getElementById("slider_nav-button--next").addEventListener("click", () => {
	//     changeSlide(currentSlide + 1)
	// });

	// document.getElementById("slider_nav-button--prev").addEventListener("click", () => {
	//     changeSlide(currentSlide - 1)
	// });
